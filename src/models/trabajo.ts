...
class Trabajos {
  ...
  conseguirTrabajos() {
    return new Promise(async (resolve, reject) => {
      connection.query(
        `SELECT * FROM trabajo WHERE Estatus = 1 limit 10`,
  ...
  conseguirTrabajosCreados(EmpresaId: number) {
    return new Promise(async (resolve, reject) => {
      connection.query(
        `SELECT * FROM trabajo WHERE Estatus = 1 AND Empresa_Id = ?`,
        [EmpresaId],
        async (err: any, results: any) => {
          if (err) {
            reject(err);
  ...
  eliminarTrabajo(id: number) {
    return new Promise(async (resolve, reject) => {
      connection.query(
        `UPDATE trabajo SET Estatus = 0 WHERE Id = ? `,
        [id],
        async (err: any, results: any) => {
          if (err) {
            reject(err);
  ...
  buscarCiudades() {
    return new Promise(async (resolve, reject) => {
      connection.query(
        `SELECT DISTINCT Ciudad FROM trabajo WHERE Estatus = 1`,
        async (err: any, results: any) => {
          if (err) {
            reject(err);
          }
  ...
  buscarTrabajoConTexto(texto: string) {
    return new Promise(async (resolve, reject) => {
      connection.query(
        `SELECT * FROM trabajo WHERE Estatus = 1 AND Titulo LIKE ?`,
        ["%" + texto + "%"],
        async (err: any, results: any) => {
          if (err) {
            reject(err);
  ...
  //buscar trabajos similares a los que busco el usuario y ciudad
  buscarTrabajoConTextoYCiudad(texto: string, ciudad: string) {
    return new Promise(async (resolve, reject) => {
      connection.query(
